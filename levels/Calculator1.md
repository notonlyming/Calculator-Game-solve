...
note: 3905 time(s) try, 3 solution(s) found
### Level 180
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------10-----------------------
发现解(3步)：(－1) (1) (1) 结果：10
发现解(3步)：(1) (1) (－1) 结果：10

note: 14 time(s) try, 2 solution(s) found
### Level 181
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------64-----------------------
发现解(2步)：(6) (4) 结果：64

note: 6 time(s) try, 1 solution(s) found
### Level 182
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------35-----------------------
发现解(3步)：(×5) (×3) (＋5) 结果：35
发现解(3步)：(×3) (×5) (＋5) 结果：35

note: 39 time(s) try, 2 solution(s) found
### Level 183
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------131-----------------------
发现解(4步)：(×2) (3) (＋1) (＋1) 结果：131

note: 120 time(s) try, 1 solution(s) found
### Level 184
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------123-----------------------
...
### Level 187
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------13-----------------------
发现解(4步)：(SUM) (lnv10) (Mirror) (SUM) 结果：13

note: 120 time(s) try, 1 solution(s) found
### Level 188
请输入传送门传送入口和传送出口位置（空格分隔）：-----------------------822-----------------------
