...
发现解(3步)：(1=>67) (Shift<5) (<<) 结果：678  
发现解(3步)：(Shift<1) (1=>67) (<<) 结果：678  
发现解(3步)：(Shift<4) (1=>67) (<<) 结果：678  
发现解(3步)：(Shift<1) (<<) (1=>67) 结果：678  
发现解(3步)：(Shift<4) (<<) (1=>67) 结果：678  
...
发现解(3步)：(Shift<2) (×2) (Shift<1) 结果：101  
发现解(3步)：(Shift<3) (×2) (Shift<1) 结果：101  
发现解(3步)：(Shift<4) (×2) (Shift<1) 结果：101  
发现解(3步)：(Shift<5) (×2) (Shift<1) 结果：101  
发现解(3步)：(Shift<6) (×2) (Shift<1) 结果：101  

note: 399 time(s) try, 7 solution(s) found
-----------------------22-----------------------  
发现解(3步)：(×2) (×2) (Shift<2) 结果：22  
发现解(3步)：(×2) (×2) (Shift<3) 结果：22  
发现解(3步)：(×2) (×2) (Shift<4) 结果：22  
发现解(3步)：(×2) (×2) (Shift<5) 结果：22  
发现解(3步)：(×2) (×2) (Shift<6) 结果：22  
发现解(3步)：(×2) (Shift<2) (×2) 结果：22  
发现解(3步)：(×2) (Shift<3) (×2) 结果：22  
发现解(3步)：(×2) (Shift<4) (×2) 结果：22  
发现解(3步)：(×2) (Shift<5) (×2) 结果：22  
发现解(3步)：(×2) (Shift<6) (×2) 结果：22  

note: 399 time(s) try, 10 solution(s) found
